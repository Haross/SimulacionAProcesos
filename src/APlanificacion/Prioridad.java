...
public class Prioridad extends Thread{
   ...
   public Prioridad(TableView tableV,TextArea txtTe,TextArea  txtTr,TextArea txtP){
       this.tableV = tableV;
       this.txtP = txtP;
       this.txtTe = txtTe;
       this.txtTr = txtTr;
   ...
   private void setTabla(String pri,String tL,String tR,String te,String tRespuesta,String penali,String or){
       ...
       for (int i = 0; i < data.size(); i++) {
            ...
            if(pri.equals(data.get(i).getPrioridad()) && tL.equals(data.get(i).getTiempoLlegada()) && 
